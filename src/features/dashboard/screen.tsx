...
export function DashboardScreen() {
  ...
  const show = useCallback(
    (id: (typeof dashLayout)[number]['id']) =>
      dashLayout.find((c) => c.id === id)?.visible !== false,
    [dashLayout]
  );
  const orderedSections = dashLayout.filter((c) => c.visible);

  return (
    <Screen>
      <View className='flex-1' style={{ paddingHorizontal: layout.gutter }}>
        <FlashList
          data={show('transactions') ? txns : []}
            ...
            <View>
              <View className='flex-row items-center justify-between pt-2'>
                ...
                <IconButton
                  ...
                  onPress={() =>
                    router.push('/planning/customize-home' as Href)
                  }
                />
                <IconButton
              ...
              {orderedSections.map((section) => {
                if (section.id === 'balance') {
                  return (
                    <View key='balance' className='mt-5'>
                      <BalanceCard
                ...
                if (section.id === 'actions') {
                  return (
                    <View key='actions' className='mt-4 flex-row gap-3'>
                      <ActionTile
                        label='Add'
                ...
                if (section.id === 'summary') {
                  return (
                    <View key='summary' className='mt-4'>
                      <SummaryStrip
                        items={[
                          {
                            label: 'Spent',
                ...
                if (section.id === 'goals' && goals.length > 0) {
                  return (
                    <Pressable
                      key='goals'
                ...
                if (section.id === 'activity') {
                  return (
                    <View key='activity' className='mt-3'>
